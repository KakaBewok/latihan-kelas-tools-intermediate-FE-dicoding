...
const Edit = {
  ...
  _populateTransactionToForm(transactionRecord = null) {
    ...
    const nameRecord = document.querySelector('#validationCustomRecordName');
    const amountRecord = document.querySelector('#validationCustomAmount');
    const dateRecord = document.querySelector('#validationCustomDate');
    const evidenceRecord = document.querySelector('#inputImagePreviewEdit');
    const descriptionInput = document.querySelector('#validationCustomNotes');
    const inputRadioTransactionTypeEdit = document.querySelector('#inputRadioTransactionTypeEdit');

    nameRecord.value = transactionRecord.name;
    amountRecord.value = transactionRecord.amount;
